...
**NOTE:** Email Before Download currently does not work with Contact Form 7 ver 7.3.9. We are currently working on a update to be compatible. You can get CF7 ver 7.3.8 [here](downloads.wordpress.org/plugin/contact-form-7.3.8.zip). Thank you for using our plugin.
